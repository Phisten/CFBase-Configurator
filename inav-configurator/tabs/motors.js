    ...
    function process_html() {
        ...
        function update_ui() {            
            ...
            for (var i = 0; i < MOTOR_DATA.length; i++) {
                ...
                $('.motor-' + i + ' .indicator', motors_wrapper).css({'margin-top' : margin_top + 'px', 'height' : height + 'px', 'background-color' : '#f43933'+ color +')'});
            }
            ...
            for (var i = 0; i < SERVO_DATA.length; i++) {
                ...
                $('.servo-' + i + ' .indicator', servos_wrapper).css({'margin-top' : margin_top + 'px', 'height' : height + 'px', 'background-color' : '#f43933'+ color +')'});
            }
